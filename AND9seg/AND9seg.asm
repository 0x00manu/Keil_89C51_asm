...
; AnD for 1+7+2 remains. 1 segment is for sign,S,Unstable
; stability, unstability and negative sign is needed
; units aren't displing correctly.
...
;|45|44|43|42 |41|40|
 	...
 	RET;common
				...
				gram:
					...
					mov		45h,3Ah
					mov 	44h,38h
					anl		44h,#0FBh	;39 is decimal;P0.2 -> h
					mov		43h,37h
					mov		42h,36h
				...
				GN:
					...
					mov		45h,39h
					anl		45h,#0FBh
					mov 	44h,38H		;2nd 7-seg from left
					mov 	43h,37H		;3rd
					mov 	42h,36H		;4th
					mov 	41h,35h	 	;5th
					mov 	40h,34h	 	;6th
					mov TEMP,#05h 		;mask 44h,43h,42h,41h if required
					mov TEMPPTR,#40h
					call maskzeros
